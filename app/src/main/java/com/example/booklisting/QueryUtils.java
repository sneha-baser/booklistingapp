...
/**
 * Helper methods related to requesting and receiving books data from Google Book API.
 */
public final class QueryUtils {
     ...
     */
    public static ArrayList<Book> extractBooks(String bookJsonResponse) {
        ...
        try {
            ...
            JSONObject raw = new JSONObject(bookJsonResponse);

            JSONArray items = raw.getJSONArray("items");
